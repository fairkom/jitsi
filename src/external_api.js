!(function (e, t) {
	"object" == typeof exports && "object" == typeof module
		...
		? (exports.fairmeetingMeetExternalAPI = t())
		: (e.fairmeetingMeetExternalAPI = t());
})(window, function () {
	return (function (e) {
		var t = {};
		function n(r) {
		...
		function (e, t, n) {
			...
			const g = s(window.location).fairmeeting_meet_external_api_id,
				y = {};
			let _;
			"number" == typeof g && (y.scope = "fairmeeting_meet_external_api_" + g),
				((window.fairmeetingMeetJS || (window.fairmeetingMeetJS = {}),
				window.fairmeetingMeetJS.app || (window.fairmeetingMeetJS.app = {}),
				window.fairmeetingMeetJS.app).setExternalTransportBackend = (e) =>
					_.setBackend(e));
			var b = n(4),
				w = n(0);
			function L(e, t) {
			...
			function I(e, t = {}) {
				return u(
					(function (e) {
						...
						url: `${
							t.noSSL ? "http" : "https"
						}://${e}/#fairmeeting_meet_external_api_id=${C}`,
					})
				);
			}
			function R(e) {
			...
			class k extends i.a {
				constructor(e, ...t) {
					...
					(this._parentNode = s),
						...
						(this._transport = new v({
							backend: new m({
								postisOptions: {
									scope: "fairmeeting_meet_external_api_" + C,
				...
				_createIFrame(e, t, n) {
					const r = "fairmeetingConferenceFrame" + C;
